...
translate spanish strings:
    ...
    old "Previous Entry"
    new _p("""Entrada anterior""")

    old "Next Entry"
    new _p("""Entrada siguiente""")

    old "Previous Page"
    new _p("""Pagina anterior""")

    old "Next Page"
    new _p("""Siguiente página""")

    old "Close Entry"
    new _p("""Cerrar entrada""")
    ...
    new _p("""v[config.version] • Edición tabú, escenas adicionales""")

    old "v[config.version] • Standard Edition, Extra Scenes"
    new _p("""v[config.version] • Edición estándar, escenas adicionales""")

    old "v[config.version] • Taboo Edition"
    new _p("""v[config.version] • Edición tabú""")

    old "v[config.version] • Standard Edition"
    new _p("""v[config.version] • Edición estándar""")

    old "Support me on  Patreon:\nwww.patreon.com/perverteer"
    new _p("""Apóyame en Patreon:\nwww.patreon.com/perverteer""")

    old "Unlock Scenes"
    new _p("""Desbloquear escenas""")

    old "Lock Scenes"
    new _p("""Escenas de bloqueo""")

    old "{b}A big thank you to my top tier backers, you rock!{/b}"
    new _p("""{b}Muchas gracias a mis patrocinadores de primer nivel, ¡sois geniales!{/b}""")
    ...
    new "reenvío automático después de click"
    ...
    new "\n{color=#cfc}✔ imagen pronosticada (buena){/color}\n{color=#fcc}✘ imagen no pronosticada (mala){/color}\n{color=#fff}Arrastrar para mover.{/color}"
    ...
    new "Forzar renderizador GLES21"
    ...
    new "Error al analizar el script."# TODO: Translation updated at 2023-08-25 14:38
